...
public class CancelTaskActivity extends AppianSmartService {

	private static final Logger LOG = Logger.getLogger(CancelTaskActivity.class);
	...
	public CancelTaskActivity(ProcessExecutionService pes_) {
		super();
		this._pes = pes_;
	}
