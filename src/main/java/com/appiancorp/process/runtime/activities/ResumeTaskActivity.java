...
public class ResumeTaskActivity extends AppianSmartService {

	private static final Logger LOG = Logger.getLogger(ResumeTaskActivity.class);
	...
	public ResumeTaskActivity(ProcessExecutionService pes_) {
		super();
		this._pes = pes_;
	}
